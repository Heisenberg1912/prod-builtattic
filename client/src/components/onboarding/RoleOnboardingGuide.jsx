...
const ROLE_STEPS = {
  firm: {
    ...
    steps: [
      ...
      {
        id: "review-dashboard",
        title: "Review the firm dashboard",
        description: "Track leads, invites, and pack status from the dashboard once you land.",
        action: { label: "Go to firm dashboard", href: "/dashboard/firm" },
      },
    ],
  },
  vendor: {
  ...
  associate: {
    ...
    steps: [
      ...
      },
      {
        ...
        title: "Track the associate dashboard",
        description: "Pitches, schedules, and onboarding status live together on this page.",
        action: { label: "Go to associate dashboard", href: "/dashboard/associate" },
      },
    ],
  },
  user: {
